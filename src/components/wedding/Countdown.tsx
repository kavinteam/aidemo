      ...
      <div className="flex justify-center gap-4 md:gap-8">
        {timeUnits.map((unit) => (
          <div key={unit.label} className="flex flex-col items-center">
            <span className="text-4xl md:text-6xl font-headline font-light text-primary">--</span>
            <span className="text-sm md:text-base font-body uppercase tracking-wider text-accent">{unit.label}</span>
          </div>
        ))}
      </div>
    );
